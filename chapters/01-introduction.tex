...
\ac{XC} risolve questa limitazione unificando le due categorie di valori in una singola classe denominata \texttt{nvalues} (\(v\)), consentendo così a ciascun dispositivo di inviare messaggi diversi a vicini differenti (comunicazione \textit{anisotropica}).
