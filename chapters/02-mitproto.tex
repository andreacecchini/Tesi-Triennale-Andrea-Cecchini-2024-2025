...
\paragraph{Restrizione del dominio} L'operatore \texttt{if} partiziona la rete dei dispositivi in due sottoinsiemi in base alla valutazione di una condizione. La sintassi è la seguente (\Cref{lst:mitprotoif}):
