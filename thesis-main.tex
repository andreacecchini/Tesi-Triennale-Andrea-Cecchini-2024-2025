...
Progettato per essere multipiattaforma grazie al supporto del progetto \ac{KTM}\footnote{\url{https://kotlinlang.org/docs/multiplatform.html}}, il linguaggio consente di eseguire il codice su diverse piattaforme (JVM, JavaScript e nativo) con modifiche minime. L'intero processo di build è gestito tramite Gradle\footnote{\url{https://gradle.com/}}.
